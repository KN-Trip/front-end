...
function LoginForm() {
    ...
    const [login, login_loading, login_error, loginRequest] = useLogin();
    let history = useHistory();

    if (login_loading) return <div>로딩중</div>;
                    ...
                    <LoginResponsive>
                        ...
                        <SNSLoginWrapper>
                            ...
                            <SocialLoginList>
                                <SocialItem>
                                    <CursorDiv>
                                        {IconLib.getImgIcon(kakaoIco, 40, 40)}
                                    </CursorDiv>
                                ...
                                <SocialItem>
                                    <CursorDiv>
                                        {IconLib.getImgIcon(naverIco, 40, 40)}
                                    </CursorDiv>
                                    <HorizontalMargin margin="16px" />
                                    <div>네이버</div>
                                </SocialItem>
